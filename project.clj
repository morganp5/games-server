(defproject games-server "0.1.0-SNAPSHOT"
  ...
  {:uberjar {:omit-source true
   ...
   :project/dev  {:dependencies [[prone "1.0.2"]
                  ...
                  {:http-server-root "public"
                   ...
                   :ring-handler games-server.handler/app}
                  :doo {:build "test"}
